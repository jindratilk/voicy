...
Use Node.js 22 or newer. Run `npm ci`, then `npm run dev`. The site is served on port3007. Copy configuration into a private `.env.local`; never commit it.
...
- `SESSION_SECRET`: random signing secret, at least32 random bytes.
